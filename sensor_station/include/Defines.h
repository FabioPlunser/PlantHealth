...
#define TIME_BUTTON_PRESS_TO_RESET			   (5 * 1000)
...
#define LED_COLOR_ERROR_AIR_QUALITY			   0x4F'00'FF // Yellow
#define LED_COLOR_ERROR_AIR_TEMPERATURE		   0x4F'00'00 // Red
#define LED_COLOR_ERROR_AIR_HUMIDITY		   0x4F'99'FF // White
#define LED_COLOR_ERROR_AIR_PRESSURE		   0x00'99'FF // Cyan
#define LED_COLOR_ERROR_SOIL_HUMIDITY		   0x00'99'00 // Green
#define LED_COLOR_ERROR_LIGHT_INTENSITY		   0x4F'33'00 // Magenta
#define LED_TIME_ERROR_ON_MS				   1000
#define LED_TIME_ERROR_OFF_MS				   4000
#define LED_TIME_ERROR_BLINK_PAUSE_MS		   1000

#define LED_COLOR_NOTIFICATION_PAIRING		   0x00'00'FF // Blue
#define LED_TIME_NOTIFICATION_ON_MS			   200
#define LED_TIME_NOTIFICATION_OFF_MS		   800
#define LED_TIME_NOTIFICATION_BLINK_PAUSE_MS   200
