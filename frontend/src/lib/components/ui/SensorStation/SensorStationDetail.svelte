<script lang="ts">
  ...
  // ---------------------------------------------------
  // ---------------------------------------------------
  interface SensorStationPromise extends Array<SensorStationPromise> {
    data: any[];
    [key: string]: any;
  }
  type Data = {
    ...
    sensorStations: Promise<SensorStationPromise>;
    [key: string]: any;
  };
        ...
        {#each sensorStations as sensorStation, i (sensorStation.sensorStationId)}
          ...
          >
            ...
            >
              ...
              {:else}
                <div
                  class="btn-group bg-bgase-100 flex justify-center mb-4 mt-4"
                >
                ...
                {:else if state === "limits"}
                  ...
                  {:else}
                    ...
                    {:then limits}
                      <div
                        class="grid grid-rows sm:grid-cols-2 md:grid-cols-4 xl:grid-cols-5 gap-4"
                      >
