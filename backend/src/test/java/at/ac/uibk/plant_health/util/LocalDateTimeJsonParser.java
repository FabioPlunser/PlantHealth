...
public class LocalDateTimeJsonParser extends BaseMatcher<LocalDateTime> {
	...
	public static LocalDateTimeJsonParser equalsWithTolerance(
			LocalDateTime dateTime, TemporalAmount tolerance
	) {
	...
	public void describeTo(Description description) {
		description.appendText(String.format("LocalDateTime between %s and %s", from, to));
	}
}